...
<head>
    ...
    <style>
        ...
        .sidebar-nav li:nth-child(7) a { border-left-color: #D4AF37; background: rgba(212, 175, 55, 0.12); color: #D4AF37; }
        ...
        /* Archived section */
        .archived-card { background: #fff; border: 2px solid #0b0b0b; border-radius: 4px; padding: 1.5rem; }
        .archived-title { font-weight: 800; text-transform: uppercase; letter-spacing: 0.8px; font-size: 1.05rem; color: #0b1720; margin: 0 0 1rem 0; }
        .archived-tools { display: grid; grid-template-columns: 1.4fr 1fr 1fr auto; gap: 12px; margin-bottom: 16px; }
        .archived-tools input { height: 42px; border: 1px solid #cbd5e1; border-radius: 10px; padding: 0 12px; font-size: 14px; color: #1e293b; background: #fff; outline: none; }
        .archived-tools input:focus { border-color: #1e3a5f; box-shadow: 0 0 0 3px rgba(30,58,95,0.15); }
        .archived-btn { height: 42px; border: none; border-radius: 10px; padding: 0 16px; background: #1e3a5f; color: #fff; font-size: 14px; font-weight: 600; cursor: pointer; display: inline-flex; align-items: center; gap: 8px; }
        .archived-btn:hover { background: #2d4a6f; }
        .archived-btn svg { width: 18px; height: 18px; flex-shrink: 0; }
        .archived-table-frame { border: 1px solid #e2e8f0; border-radius: 12px; background: #fff; overflow: hidden; margin-top: 1rem; }
        .archived-table { width: 100%; border-collapse: collapse; }
        .archived-table thead th { text-align: left; padding: 14px 16px; font-size: 13px; font-weight: 600; letter-spacing: 0.03em; color: #475569; border-bottom: 1px solid #e2e8f0; background: #f8fafc; }
        .archived-table tbody td { padding: 14px 16px; border-bottom: 1px solid #f1f5f9; color: #334155; font-size: 14px; }
        .archived-empty { text-align: center; height: 200px; color: #64748b; vertical-align: middle; }
        @media (max-width: 980px) { .archived-tools { grid-template-columns: 1fr 1fr; } }
    </style>
</head>
<body>
        ...
        <div class="main-content">
            ...
            <div class="content-body">
                <section class="archived-card">
                    <h2 class="archived-title">Archived Documents</h2>
                    <div class="archived-tools">
                        ...
                        <button type="button" class="archived-btn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>Search</button>
                    </div>

                    <div class="archived-table-frame">
                        <table class="archived-table">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="5" class="archived-empty">No archived documents yet.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
